...
public class FileManagerTest {
	...
	private static final FileManager MANAGER = new FileManager(BASEPATH);
	...
	public void testCreateFile() {
		try {
			String fileName = MANAGER.createFile();
	...
	public void testUpdateEmptyFile() {
		try {
			...
			MANAGER.updateFile(inputStream, DEFAULTEMPTYFILELOCATION);
